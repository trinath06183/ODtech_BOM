...
ALLOWED_HOSTS += ['.pythonanywhere.com'] # Allow pythonanywhere subdomains

CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8001', 'http://localhost:8001', 'http://127.0.0.1:8000', 'http://localhost:8000', 'https://*.ngrok-free.dev', 'https://*.ngrok.io', 'https://*.ngrok.app', 'https://*.pythonanywhere.com']
...
COMPRESS_ENABLED = not DEBUG  # Compress only in production mode
